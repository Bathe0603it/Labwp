<?php
    ...
    $tabs = array(
        array(
            ...
            'content' => __( '<p>Hey cái help 1 này.</p>', 'redux-framework-demo' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
        ...
        array(
            'id'      => 'redux-help-tab-3',
            'title'   => __( 'Theme Information 2', 'redux-framework-demo' ),
            'content' => __( '<p>Help 3 này.</p>', 'redux-framework-demo' )
        )
    );
    ...
    Redux::setSection( $opt_name, array(
        'title'  => __( 'Basic Field', 'lab4' ),
        'id'     => 'basic',
        'desc'   => __( 'Basic field with no subsections.', 'lab4' ),
        'icon'   => 'el el-home',
        'fields' => array(
            array(
                'id'       => 'logo-on',
                'type'     => 'switch',
                'title'    => __( 'On/Off logo', 'lab4' ),
                'desc'     => __( 'Bật tắt logo', 'lab4' ),
                'subtitle' => __( 'Mời bạn chọn.', 'lab4' ),
                'hint'     => array(
            ...
            array(
                'id'       => 'logo-image',
                'type'     => 'media',
                'title'    => __( 'Logo Image', 'lab4' ),
                'desc'     => __( 'Upload image logo.', 'lab4' ),
                'subtitle' => __( 'Mời bạn chọn.', 'lab4' ),
                'hint'     => array(
                    'content' => 'This is a <b>hint</b> tool-tip for the text field.<br/><br/>Add any HTML based text you like here.',
                )
